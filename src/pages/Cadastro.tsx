      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden items-center justify-center">
        ...
        <div className="relative z-10 text-center px-12">
          ...
          <p className="text-muted-foreground text-lg">
            Crie sua conta e comece a gerenciar sua associação esportiva.
          </p>
        </div>
      </div>
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input id="name" placeholder="Seu nome completo" className="pl-10 h-12 bg-secondary border-border" />
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input id="phone" placeholder="(00) 00000-0000" className="pl-10 h-12 bg-secondary border-border" />
              </div>
            </div>
